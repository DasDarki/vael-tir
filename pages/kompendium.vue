...
<template>
  <div class="ff">
    <header class="ff__header">
      <div class="ff__brand">
        <NuxtLink to="/" class="ff__back" aria-label="Zurück zur Übersicht">‹</NuxtLink>
...
.ff {
  // Lokale Aliase auf die globalen Theme-Tokens → folgt Hell/Dunkel.
  --panel: var(--surface);
  --panel-2: var(--surface-2);
  --border-2: var(--hairline);
  --gold-2: var(--hairline);
  --glow: rgba(var(--gold-raw), 0.22);
  --danger: #d4646e;
